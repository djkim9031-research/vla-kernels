...
# kernel path: /work/.inductor_cache_flash/3q/c3qg5chxf24w4iols7p37ovqo7tdy6leh3xtr7ewrh4rk7lmogvf.py
# Topologically Sorted Source Nodes: [patch_attention_mask_1], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   patch_attention_mask_1 => full_default
# Graph fragment:
#   %full_default : Tensor "b8[1, 32, 32][1024, 32, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([1, 32, 32], True), kwargs = {dtype: torch.bool, layout: torch.strided, device: cuda:0, pin_memory: False})
#   return %full_default
...
def partition_0(args):
    with torch.cuda._DeviceGuard(0):
        ...
        buf0 = empty_strided_cuda((1, 32, 32), (1024, 32, 1), torch.bool)
        # Topologically Sorted Source Nodes: [patch_attention_mask_1], Original ATen: [aten._to_copy]
        stream0 = get_raw_stream(0)
        triton_poi_fused__to_copy_0.run(buf0, 1024, stream=stream0)
    return (buf0, )
