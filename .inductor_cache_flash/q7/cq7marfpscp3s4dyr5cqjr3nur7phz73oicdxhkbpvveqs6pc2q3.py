...
# kernel path: /work/.inductor_cache_flash/lj/cljim4wrctorthlxnhusda2rjpd6r4xybec5yhawbtokfyvwsze2.py
...
# kernel path: /work/.inductor_cache_flash/7g/c7gv35k7fzxtagxzdohwl6d5ivlfsbabpzsy5dtrb3uc5b6r3gza.py
...
# kernel path: /work/.inductor_cache_flash/bn/cbnjmtz6sdlusxczs4wveburx6i7xtuy3bquaygl3sdbbjbm6wyn.py
# Topologically Sorted Source Nodes: [attn_output_3, hidden_states_1, hidden_states_2], Original ATen: [aten.view, aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   attn_output_3 => view_12
#   hidden_states_1 => add_4
...
# kernel path: /work/.inductor_cache_flash/gl/cglfzhznykeicm3f5dhbresgpkgf26kr3bdisresdkcowhz7ehqf.py
# Topologically Sorted Source Nodes: [attn_output_3, hidden_states_1, hidden_states_2], Original ATen: [aten.view, aten.add, aten.native_layer_norm]
# Source node to ATen node mapping:
#   attn_output_3 => view_12
#   hidden_states_1 => add_4
...
# kernel path: /work/.inductor_cache_flash/wo/cwokuzyxjzeap4qjrdlhgp5play5i3zadgssrg4e7xoxjctiz2nn.py
...
# kernel path: /work/.inductor_cache_flash/7m/c7mi36r3cyrvmipvhg27xgs7mmh7ant42m7lbbsifsjfeinx25hj.py
...
# kernel path: /work/.inductor_cache_flash/yo/cyotcxbjs5zkb4aeurqrk6ij4ksxbcxnqxw5etvtihl4gdipytt7.py
...
# kernel path: /work/.inductor_cache_flash/46/c4677zmq4lclxlaxrnbej766zkm2sul4n54k7kjowqumwpvwtuhq.py
...
# kernel path: /work/.inductor_cache_flash/2s/c2sxsphr2mm65is5pjp2ihlqyvzzmpz3lxxu7eullgx4gpu624zw.py
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_view_11', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'atomic_add_found': False, 'num_load': 4, 'num_store': 1, 'num_reduction': 4, 'backend_hash': '399E50A3AF6A9A1E6899E01CB1A675B878ADF966B91D45205A7FC9E0251DE912', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False, 'tiling_scores': {'x': 0, 'r0_': 6294528}}
)
@triton.jit
...
# kernel path: /work/.inductor_cache_flash/jb/cjbph34r7676f3miqznbtqswazxsu5ydwckrl7udrwjk66eqryga.py
...
# kernel path: /work/.inductor_cache_flash/7a/c7aemgqdm72h636vpr6lpj4ekfos5narfbcd2iqwfyeviwjnxqgh.py
...
@triton_heuristics.persistent_reduction(
    ...
    inductor_meta={'grid_type': 'Grid1D', 'autotune_hints': set(), 'kernel_name': 'triton_per_fused_add_native_layer_norm_view_13', 'mutated_arg_names': [], 'optimize_mem': True, 'no_x_dim': None, 'atomic_add_found': False, 'num_load': 6, 'num_store': 1, 'num_reduction': 4, 'backend_hash': '399E50A3AF6A9A1E6899E01CB1A675B878ADF966B91D45205A7FC9E0251DE912', 'assert_indirect_indexing': True, 'autotune_local_cache': True, 'autotune_pointwise': True, 'autotune_remote_cache': None, 'force_disable_caches': False, 'dynamic_scale_rblock': True, 'max_autotune': False, 'max_autotune_pointwise': False, 'min_split_scan_rblock': 256, 'spill_threshold': 16, 'store_cubin': False, 'deterministic': False, 'force_filter_reduction_configs': False, 'mix_order_reduction_allow_multi_stages': False, 'are_deterministic_algorithms_enabled': False, 'tiling_scores': {'x': 0, 'r0_': 9440256}}
)
@triton.jit
...
# kernel path: /work/.inductor_cache_flash/ve/cvederqk5rx4vcs3tv7slichlbxoeq3blnrobzvfpazbyo4bszrx.py
...
# kernel path: /work/.inductor_cache_flash/z6/cz64zelybdde2h2l7ln5xsgf4zdi4fi6u7arr56pxftpf4jkv4i2.py
